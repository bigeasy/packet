        ...
        object: function () {
            return function (object) {
                return function ($buffer, $start, $end) {
                    ...
                    if ($end - $start < 4) {
                        return $incremental.object(object, 2, $i, $accumulator, $starts)($buffer, $start, $end)
                    }
                    ...
                    for ($i[0] = 0; $i[0] < object.counted.string.length; $i[0]++) {
                        if ($end - $start < 1) {
                            return $incremental.object(object, 5, $i, $accumulator, $starts)($buffer, $start, $end)
                        }
                    ...
                    case 1:
                        ...
                        if ($end - $start < 1) {
                            return $incremental.object(object, 10, $i, $accumulator, $starts)($buffer, $start, $end)
                        }
                    ...
                    case 2:
                        ...
                        if ($end - $start < 2) {
                            return $incremental.object(object, 12, $i, $accumulator, $starts)($buffer, $start, $end)
                        }
                    ...
                    if ($end - $start < 1) {
                        return $incremental.object(object, 16, $i, $accumulator, $starts)($buffer, $start, $end)
                    }
