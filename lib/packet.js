module.exports.create = function () {
  var pattern = require('./__internal/pattern').parse;
  ...
  function instance (packets) {
    ...
    function next () {
      ...
      if (shiftable.length == 0) {
        ...
        machine = mechanize(
        { pattern: packets[nameOrPattern] && packets[nameOrPattern].pattern || pattern(nameOrPattern)
